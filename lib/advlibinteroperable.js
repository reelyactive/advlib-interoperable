...
/**
 * Interpret the InteroperaBLE identifiers in an advlib-standard packet.
 * @param {Object} packet An advlib-standard processed packet.
 * @return {Object} The interpreted packet.
 */
function interpret(packet) {
  let interpretedPacket = Object.assign({}, packet);

  interpretDeviceIds(packet.deviceIds, interpretedPacket);

  return interpretedPacket;
}
