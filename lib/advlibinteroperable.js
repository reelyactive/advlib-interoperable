...
const MOTION_UUID = '496f4944434f4445b73e4d6f74696f63';
const MOTION_ELIDED_UUID = '496f49444d6f74696f63';
    ...
    for(const deviceId of deviceIds) {
      ...
      switch(deviceIdElements[0]) {
        ...
        case BUTTON_ELIDED_UUID:
          ...
          break;
        case MOTION_UUID:
        case MOTION_ELIDED_UUID:
          interpretMotion(deviceIdElements, interpretedPacket);
          break;
        case FILE_MP3_UUID:
...
/**
 * Interpret the motion data.
 * @param {Array} deviceIdElements The elements of the device identifier.
 * @param {Object} interpretedPacket The partially-interpreted packet.
 */
function interpretMotion(deviceIdElements, interpretedPacket) {
  interpretedPacket.isMotionDetected = [ true ];
}
